...
import { Users, FileText, CheckSquare, Calendar, Download, RefreshCw, Eye, Search, Bell, LogOut, ChevronLeft, ChevronRight, X, AlertTriangle, CheckCircle2, Clock, Info } from 'lucide-react';
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-slate-655 mt-0.5 leading-normal text-[9px] break-words">{n.message}</p>
                            <div className="flex items-center gap-1 mt-1.5 text-[8px] text-slate-404 font-semibold">
